...
Generate ligand GAFF2/RESP parameters using SDF as the chemistry source and complex PDB as the pose source. Produce ligand-aware LEaP mapping.
...
Default H-only pre-RESP cleanup:
...
<RUN_ROOT>/13_ligand_mapping_leapin/ligand_mapping_manifest.json
